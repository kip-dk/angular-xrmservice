...
If you need support for angular 5 and below, do not take version higher than 1.3.x. Version 2.0.0 has been upgrade to use newest version of rxjs patterns.
